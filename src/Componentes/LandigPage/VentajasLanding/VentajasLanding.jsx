        ...
        <div className="ventajas-landing">
            ...
            <div className="numero">1</div>
                <p className="formato-texto">
                    ...
                    ¿Te gustaría tener un control más claro de tus ingresos y gastos? 
            ...
            <div  className="ventajas-contenedor-texto-dos">
                ...
                para un seguimiento más detallado. Ya no tendrás que preocuparte por perder el control de tus finanzas. 
